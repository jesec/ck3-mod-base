PixelShader = {
	...
	[[
		...
		#define DroughtOverlayColor					float3( 0.651f, 0.396f, 0.192f )
		...
		#define DroughtDryTexureIndex				56
		...
		#define DroughtCracksTexureIndex			57
		#define DroughtCrackedTextureUVTiling		2
		#define DroughtCracksAreaMaskTiling			10.0f

		#define DroughtCracksAreaMaskPositionFrom	0.761f
		#define DroughtCracksAreaMaskPositionTo		0.5f
		...
		#define FloodPropertiesSettings 			float4( 0.0f, 0.125f, 0.0f, 0.08f )
		...
		#define FloodWaterInnerColor				float3( 0.053f, 0.055f, 0.074f )
		#define FloodWaterEdgeColor					float3( 0.088f, 0.073f, 0.052f )

		// Summer
		#define SummerBlendWeight					1.0f
		#define SummerSlopeMin						0.2f
		#define SummerGrassOverlayColor 			float3( 0.165f, 0.208f, 0.031f )

		#define SummerGrassTexureIndex				59
		...
		#define SummerOverlayTree					float3( 0.453f, 0.563f, 0.165f )
	]]
}